    ...
    fetch(uri, { headers: { Authorization: auth } })
      ...
      .then((res) => {
        ...
        if (intent === "Alive_Verification") {
          ...
          speak(
            "हराएको जग्गा प्रमाणपत्र प्रतिस्थापन गर्न, कृपया हराएको प्रमाणपत्रको विवरण र कुनै पनि सम्बन्धित कागजातहरू प्रदान गर्नुहोस्।" //TODO pdf ma xaina
          );
          ...
          speak(
            "तपाईंको नाम मानकीकरण गर्न, कृपया विविधताहरूको विवरण र कुनै पनि सहायक कागजातहरू प्रदान गर्नुहोस्।" //TODO
          );
          ...
          speak(
            "भाडामा लिने सम्झौताको लागि आवेदन गर्न, कृपया सम्पत्तिको विवरण र सम्झौताका शर्तहरू प्रदान गर्नुहोस्।"//TODO paxi
          );
        } else if (intent === "Road_Area_Validation") {
          speak(
            "सडक क्षेत्र प्रमाणित गर्न, कृपया स्थान र प्रमाणित गर्ने उद्देश्यको विवरण प्रदान गर्नुहोस्।" //TODO
          );
        } else if (intent === "Road_Maintenance_Proposal") {
          speak(
            "सडक रखरखावको प्रस्ताव गर्न, कृपया सडकको अवस्था र प्रस्तावित रखरखाव योजनाको विवरण प्रदान गर्नुहोस्।"//TODO
          );
          ...
          speak(
            "सडक वा नो-सडक क्षेत्रको सर्वेक्षण गर्न, कृपया सर्वेक्षण गरिने क्षेत्र र सर्वेक्षणको उद्देश्यको विवरण प्रदान गर्नुहोस्।" //TODO
          );
          ...
          speak(
            "घर वा जग्गाका सीमानाहरू प्रमाणित गर्न, कृपया सम्पत्तिको विवरण र कुनै पनि सम्बन्धित कागजातहरू प्रदान गर्नुहोस्।" //TODO
          );
